...
class NotificationService{
  static Future<void> saveNotifications(List<NotificationModel> newNotifications) async {
  ...
  static Future<List<NotificationModel>> getNotifications() async {
    ...
    try {
      ...
      return jsonList.map((jsonItem) => NotificationModel.fromJson(jsonItem)).toList();
    } catch (e) {
