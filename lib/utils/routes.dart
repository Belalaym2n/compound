...
class Routes {
 static Route onGenerate(RouteSettings settings){
    switch(settings.name){
      case AppRoutes.addUser:return MaterialPageRoute(builder: (context)
      => const AddUsers(),);
      case AppRoutes.scanQrCode:return MaterialPageRoute(builder: (context)
      =>  QRScanPage(),);
      case AppRoutes.addUser:return MaterialPageRoute(builder: (context)
      =>  AutoLogin(),);
      case AppRoutes.splash:return MaterialPageRoute(
        builder: (context) => AnimatedSplashScreen(),);
      case AppRoutes.adminService:return
        MaterialPageRoute(builder: (context) => AdminServices(),);
      case AppRoutes.generateQr:return
